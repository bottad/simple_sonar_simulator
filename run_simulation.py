...
def main(run_config_filename: str):
    ...
    # Run the simulation
    simulator.run_simulation(poses, run_config.output_folder, run_config.name, run_config.normalize, run_config.incident_dependency, run_config.smoothing_sigma)
